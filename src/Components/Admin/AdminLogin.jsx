...
const AdminLogin = () => {
    ...
    return (
        <section className="flex justify-center bg-gradient-to-r from-slate-900 to-slate-800 h-screen" >
            <main className="lg:m-20 shadow-md bg-black  text-white  lg:rounded-lg px-2 py-10 w96">
                ...
                <form onSubmit={handleSubmit} className="lg:p-5 p-5">
                    ...
                    <button type="submit" className="lg:bg-blue-500 p-3 text-white rounded w-full mb-3 font-bold bg-blue-500">login</button>
