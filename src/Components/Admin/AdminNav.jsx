...
const AdminNav = () => {
    ...
    return (
        <>
            ...
            <nav className=' w-60 shadow-sm bg-yellow-800 lg:p-5 h-screen fixed top-0 left-0 z-10 overflow-auto'>
                <div className='mb-10'>
                ...
                <NavLink to="/user/login" className='flex gap-5 items-center ps-3 rounded-sm mb-4'>
