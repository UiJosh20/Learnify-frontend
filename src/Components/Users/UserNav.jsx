...
const UserNav = () => {
    return (
        <>
            <nav className='w-full shadow-md lg:p-7 fixed top-0 z-10'>
                <div>
            ...
            <nav className=' w-60 shadow-sm bg-gradient-to-r from-slate-950 to-slate-900 lg:p-5 h-screen fixed top-0 left-0 z-10 overflow-auto'>
                ...
                <Link className='flex gap-5 items-center  border-s-white border-s-2 ps-3 rounded-sm mb-2'>
                ...
                <Link className='flex gap-5 items-center ps-3 rounded-sm mb-4'>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" color="#ffffff" fill="none" className='fill-white'>
