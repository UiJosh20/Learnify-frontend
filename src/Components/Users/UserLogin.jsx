...
const UserLogin = () => {
    ...
    return (
        <section className="flex justify-center bg-gradient-to-r from-slate-800 to-slate-900 h-screen" >
            ...
            <h1 className="text-center w-full font-bold text-3xl text-white-300 lg:block hidden py-5">Student Portal</h1>
            ...
            <div>
                <input type="password" placeholder='Password' onChange={handleChange} name="password" value={values.password}  className="w-full p-2 mb-3 rounded-md outline-1 outline-slate-400 text-black"/>
